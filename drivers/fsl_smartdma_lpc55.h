...
/*!
 * @brief Parameter for qei
 */
typedef struct _smartdma_qei_param
{
    uint32_t *smartdma_stack;    /*!< Stack used by SMARTDMA, shall be at least 64 bytes. */
    uint32_t *p_gpio_reg;        /*!< Buffer to provide GPIO register for phaseA, phaseB. */
    uint32_t *p_qei_data;        /*!< Buffer to store qei value. */
    uint32_t *p_scan_period; 	 /*!< Scan period in 30us @150MHz. */
} smartdma_qei_param_t;
